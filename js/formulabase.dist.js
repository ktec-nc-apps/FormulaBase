...
const _hoisted_72 = { class: "fb-side-sub" }
const _hoisted_73 = { class: "fb-steps" }
const _hoisted_74 = {
  key: 0,
  class: "fb-step-op"
}
...
const _hoisted_80 = { class: "fb-side-sec" }
const _hoisted_81 = { class: "fb-side-h" }
const _hoisted_82 = {
  key: 0,
  class: "empty-hint sm"
}
const _hoisted_83 = { class: "fb-hist" }
const _hoisted_84 = ["onClick", "title"]
const _hoisted_85 = { class: "fb-hist-in" }
const _hoisted_86 = { class: "fb-hist-out" }
const _hoisted_87 = { key: 0 }
const _hoisted_88 = { class: "fb-hist-time" }
const _hoisted_89 = ["onClick", "title"]
const _hoisted_90 = ["onClick", "title"]
...
const _hoisted_176 = { class: "modal wide" }
const _hoisted_177 = { class: "modal-head" }
const _hoisted_178 = { class: "modal-body" }
const _hoisted_179 = { class: "empty-hint sm" }
const _hoisted_180 = { class: "tpl-search" }
const _hoisted_181 = /*#__PURE__*/_createElementVNode("span", { class: "tpl-search-ic" }, "🔍", -1 /* HOISTED */)
const _hoisted_182 = ["placeholder"]
const _hoisted_183 = ["title"]
const _hoisted_184 = { class: "tpl-search-count" }
const _hoisted_185 = {
  key: 0,
  class: "empty-hint sm"
}
...
const _hoisted_187 = { class: "tpl-groups" }
const _hoisted_188 = ["onClick", "aria-expanded"]
const _hoisted_189 = /*#__PURE__*/_createElementVNode("span", { class: "tpl-group-caret" }, "▶", -1 /* HOISTED */)
const _hoisted_190 = { class: "tpl-group-ic" }
const _hoisted_191 = { class: "tpl-group-title" }
const _hoisted_192 = { class: "tpl-group-n" }
const _hoisted_193 = {
  key: 0,
  class: "tpl-grid"
}
...
const _hoisted_195 = { class: "tpl-card-h" }
const _hoisted_196 = ["onClick", "title", "aria-label"]
const _hoisted_197 = { class: "tpl-name" }
const _hoisted_198 = ["title"]
const _hoisted_199 = ["innerHTML"]
const _hoisted_200 = ["innerHTML"]
const _hoisted_201 = { class: "modal-foot" }
const _hoisted_202 = /*#__PURE__*/_createElementVNode("span", { class: "spacer" }, null, -1 /* HOISTED */)
const _hoisted_203 = { class: "modal" }
const _hoisted_204 = { class: "modal-head" }
const _hoisted_205 = { class: "modal-body settings-body" }
const _hoisted_206 = { class: "field" }
const _hoisted_207 = { class: "radios" }
const _hoisted_208 = {
  class: "field",
  style: {"margin-top":"16px"}
}
const _hoisted_209 = { value: "auto" }
const _hoisted_210 = ["value"]
const _hoisted_211 = { class: "field-hint" }
const _hoisted_212 = {
  class: "field",
...
const _hoisted_214 = { style: {"display":"flex","gap":"8px","flex-wrap":"wrap"} }
const _hoisted_215 = { class: "modal-foot" }
const _hoisted_216 = /*#__PURE__*/_createElementVNode("span", { class: "spacer" }, null, -1 /* HOISTED */)
const _hoisted_217 = { class: "modal" }
const _hoisted_218 = { class: "modal-head" }
const _hoisted_219 = ["disabled"]
const _hoisted_220 = { style: {"margin-top":"0","font-size":"13px","color":"var(--muted)"} }
const _hoisted_221 = { class: "field" }
...
const _hoisted_225 = { class: "modal-foot" }
const _hoisted_226 = ["disabled"]
const _hoisted_227 = ["disabled"]
const _hoisted_228 = { class: "modal" }
const _hoisted_229 = { class: "modal-head" }
const _hoisted_230 = ["disabled"]
const _hoisted_231 = { class: "modal-body" }
const _hoisted_232 = { class: "filepick" }
const _hoisted_233 = { class: "btn sm" }
const _hoisted_234 = { class: "filepick-name" }
const _hoisted_235 = {
  class: "field",
  style: {"margin-top":"12px"}
}
const _hoisted_236 = { class: "field" }
const _hoisted_237 = { class: "radios" }
const _hoisted_238 = { style: {"color":"var(--danger)","font-size":"13px","background":"color-mix(in srgb,var(--danger) 12%,transparent)","padding":"8px 10px","border-radius":"8px"} }
const _hoisted_239 = { class: "confirm-check" }
const _hoisted_240 = {
  key: 1,
...
const _hoisted_242 = { class: "modal-foot" }
const _hoisted_243 = ["disabled"]
const _hoisted_244 = ["disabled"]
const _hoisted_245 = { class: "modal" }
const _hoisted_246 = { class: "modal-head" }
const _hoisted_247 = { class: "modal-body" }
const _hoisted_248 = { class: "fp-path" }
const _hoisted_249 = ["disabled"]
const _hoisted_250 = { class: "fp-cur" }
const _hoisted_251 = {
  key: 0,
  class: "empty-hint sm"
}
...
const _hoisted_256 = { class: "ni-title" }
const _hoisted_257 = /*#__PURE__*/_createElementVNode("span", { class: "ni-cat" }, "›", -1 /* HOISTED */)
const _hoisted_258 = { class: "modal-foot" }
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
                        ...
                        _createElementVNode("div", _hoisted_40, [
                          ...
                          (_ctx.canDelete)
                            ? (_openBlock(), _createElementBlock("button", {
                              ...
                              }, _toDisplayString(_ctx.t('Delete')), 9 /* TEXT, PROPS */, _hoisted_43))
                            : _createCommentVNode("v-if", true)
                        ])
                      ]),
                      (f.description)
          ...
          ? (_openBlock(), _createElementBlock("aside", _hoisted_66, [
              _createElementVNode("div", _hoisted_67, [
                _createElementVNode("div", _hoisted_68, [
                  _createTextVNode("🧭 " + _toDisplayString(_ctx.t('Calculation steps')) + " ", 1 /* TEXT */),
                  (_ctx.stepData)
                    ? (_openBlock(), _createElementBlock("button", {
                        key: 0,
                        class: "btn xs",
                        onClick: _cache[7] || (_cache[7] = $event => (_ctx.copySteps(_ctx.activeFormula))),
                        title: _ctx.t('Copy calculation')
                      }, _toDisplayString(_ctx.copiedKey==='steps'+_ctx.activeFormula.id ? '✓' : '📋'), 9 /* TEXT, PROPS */, _hoisted_69))
                    : _createCommentVNode("v-if", true),
                  (_ctx.stepData)
                    ? (_openBlock(), _createElementBlock("button", {
                        key: 1,
                        class: "btn xs",
                        onClick: _cache[8] || (_cache[8] = $event => (_ctx.openExportPicker(_ctx.activeFormula,'md'))),
                        title: _ctx.t('Save as Markdown to Nextcloud')
                      }, "📝", 8 /* PROPS */, _hoisted_70))
                    : _createCommentVNode("v-if", true),
                  (_ctx.stepData)
                    ? (_openBlock(), _createElementBlock("button", {
                        key: 2,
                        class: "btn xs",
                        onClick: _cache[9] || (_cache[9] = $event => (_ctx.openExportPicker(_ctx.activeFormula,'ods'))),
                        title: _ctx.t('Save as ODS (calculable spreadsheet)')
                      }, "📊", 8 /* PROPS */, _hoisted_71))
                    : _createCommentVNode("v-if", true)
                ]),
                _createElementVNode("div", _hoisted_72, _toDisplayString(_ctx.t(_ctx.activeFormula.name)), 1 /* TEXT */),
                (_ctx.stepData)
                      ...
                      (_ctx.stepData.value!=null)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_76, [
                            ...
                            (_ctx.activeFormula.result_unit)
                              ? (_openBlock(), _createElementBlock("span", _hoisted_77, _toDisplayString(_ctx.activeFormula.result_unit), 1 /* TEXT */))
                              : _createCommentVNode("v-if", true)
                          ]))
                        : _createCommentVNode("v-if", true)
                    ], 64 /* STABLE_FRAGMENT */))
                  : (_ctx.stepError)
                    ? (_openBlock(), _createElementBlock("p", _hoisted_78, "⚠ " + _toDisplayString(_ctx.te(_ctx.stepError)), 1 /* TEXT */))
                    : (_openBlock(), _createElementBlock("p", _hoisted_79, _toDisplayString(_ctx.t('Enter all values to see the steps.')), 1 /* TEXT */))
              ]),
                ...
                _createElementVNode("div", _hoisted_81, [
                  ...
                  ((_ctx.history[_ctx.activeFormula.id]||[]).length)
                    ? (_openBlock(), _createElementBlock("button", {
                        key: 0,
                        class: "btn xs",
                        onClick: _cache[10] || (_cache[10] = $event => (_ctx.clearHistory(_ctx.activeFormula)))
                      }, _toDisplayString(_ctx.t('Clear')), 1 /* TEXT */))
                    : _createCommentVNode("v-if", true)
                ]),
                (!(_ctx.history[_ctx.activeFormula.id]||[]).length)
                  ? (_openBlock(), _createElementBlock("p", _hoisted_82, _toDisplayString(_ctx.t('Press “Record” to log a calculation.')), 1 /* TEXT */))
                  : _createCommentVNode("v-if", true),
                _createElementVNode("ul", _hoisted_83, [
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList((_ctx.history[_ctx.activeFormula.id]||[]), (h, i) => {
                    return (_openBlock(), _createElementBlock("li", {
                      ...
                      _createElementVNode("button", {
                        ...
                        _createElementVNode("span", _hoisted_85, _toDisplayString(h.label), 1 /* TEXT */),
                        _createElementVNode("span", _hoisted_86, [
                          _createTextVNode("= " + _toDisplayString(h.result), 1 /* TEXT */),
                          (h.unit)
                            ? (_openBlock(), _createElementBlock("span", _hoisted_87, _toDisplayString(h.unit), 1 /* TEXT */))
                            : _createCommentVNode("v-if", true)
                        ]),
                        _createElementVNode("span", _hoisted_88, _toDisplayString(_ctx.fmtTime(h.created_at)), 1 /* TEXT */)
                      ], 8 /* PROPS */, _hoisted_84),
                      _createElementVNode("button", {
                        class: "fb-hist-copy",
                        onClick: _withModifiers($event => (_ctx.copyHistory(h,'value')), ["stop"]),
                        title: _ctx.t('Copy result')
                      }, _toDisplayString(_ctx.copiedKey==='h'+h.id+'-value' ? '✓' : '📋'), 9 /* TEXT, PROPS */, _hoisted_89),
                      _createElementVNode("button", {
                        class: "fb-hist-copy",
                        onClick: _withModifiers($event => (_ctx.copyHistory(h,'line')), ["stop"]),
                        title: _ctx.t('Copy line')
                      }, _toDisplayString(_ctx.copiedKey==='h'+h.id+'-line' ? '✓' : '📄'), 9 /* TEXT, PROPS */, _hoisted_90),
                      _createElementVNode("button", {
                        class: "fb-hist-del",
    ...
    (_ctx.modal==='collection')
      ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "modal-mask",
          onClick: _cache[33] || (_cache[33] = _withModifiers($event => (_ctx.modal=null), ["self"]))
        }, [
          _createElementVNode("div", _hoisted_92, [
            _createElementVNode("div", _hoisted_93, [
              ...
              _createElementVNode("button", {
                class: "icon-btn",
                onClick: _cache[11] || (_cache[11] = $event => (_ctx.modal=null))
              }, "✕")
            ]),
            _createElementVNode("div", _hoisted_94, [
              _createElementVNode("div", _hoisted_95, [
                ...
                _withDirectives(_createElementVNode("input", {
                  class: "control",
                  "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((_ctx.collForm.name) = $event)),
                  onKeyup: _cache[13] || (_cache[13] = _withKeys((...args) => (_ctx.saveCollection && _ctx.saveCollection(...args)), ["enter"]))
              ...
              _createElementVNode("div", _hoisted_96, [
                ...
                _withDirectives(_createElementVNode("textarea", {
                  class: "control",
                  "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((_ctx.collForm.description) = $event)),
              ...
              _createElementVNode("div", _hoisted_98, [
                _createElementVNode("div", _hoisted_99, [
                  ...
                  _withDirectives(_createElementVNode("input", {
                    type: "color",
                    class: "control",
                    "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((_ctx.collForm.color) = $event)),
                ...
                _createElementVNode("div", _hoisted_100, [
                  ...
                  _createElementVNode("div", _hoisted_101, [
                    _createElementVNode("button", {
                      ...
                      onClick: _cache[16] || (_cache[16] = _withModifiers((...args) => (_ctx.openIconPicker && _ctx.openIconPicker(...args)), ["stop"])),
                      title: _ctx.t('Click to choose an icon')
                    }, _toDisplayString(_ctx.collForm.icon || '🧮'), 11 /* TEXT, CLASS, PROPS */, _hoisted_102),
                    _withDirectives(_createElementVNode("input", {
                      "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((_ctx.collForm.icon) = $event)),
                      maxlength: "16",
                    ...
                    (_ctx.iconPickerOpen)
                      ? (_openBlock(), _createElementBlock("div", {
                          ...
                          _withDirectives(_createElementVNode("input", {
                            class: "emoji-search",
                            "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((_ctx.emojiQuery) = $event)),
                  ...
                  (_ctx.iconPickerOpen)
                    ? (_openBlock(), _createElementBlock("div", {
                        key: 0,
                        class: "perm-backdrop",
                        onClick: _cache[20] || (_cache[20] = $event => (_ctx.iconPickerOpen = false))
                      }))
                    : _createCommentVNode("v-if", true)
                ])
              ]),
              (_ctx.collForm.id && _ctx.isOwner)
                ? (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("button", {
                      ...
                      onClick: _cache[21] || (_cache[21] = $event => (_ctx.shareExpanded = !_ctx.shareExpanded))
                    }, [
                    ...
                    _withDirectives(_createElementVNode("div", _hoisted_119, [
                      ...
                      _createElementVNode("div", _hoisted_127, [
                        _createElementVNode("div", _hoisted_128, [
                          (!_ctx.sharePanel.recipient)
                            ? (_openBlock(), _createElementBlock("div", _hoisted_129, [
                                _withDirectives(_createElementVNode("input", {
                                  "onUpdate:modelValue": _cache[22] || (_cache[22] = $event => ((_ctx.sharePanel.q) = $event)),
                                  onInput: _cache[23] || (_cache[23] = (...args) => (_ctx.searchShareUsers && _ctx.searchShareUsers(...args))),
                            ...
                            : (_openBlock(), _createElementBlock("div", _hoisted_134, [
                                ...
                                _createElementVNode("button", {
                                  type: "button",
                                  class: "icon-btn",
                                  onClick: _cache[24] || (_cache[24] = (...args) => (_ctx.clearShareRecipient && _ctx.clearShareRecipient(...args)))
                                }, "✕")
                              ])),
                          _createElementVNode("div", {
                            class: _normalizeClass(["perm-wrap", {open: _ctx.permOpen}]),
                            title: _ctx.t('Permission'),
                            onClick: _cache[26] || (_cache[26] = _withModifiers($event => (_ctx.permOpen = !_ctx.permOpen), ["stop"]))
                          }, [
                          ...
                          (_ctx.permOpen)
                            ? (_openBlock(), _createElementBlock("div", {
                                key: 2,
                                class: "perm-backdrop",
                                onClick: _cache[27] || (_cache[27] = $event => (_ctx.permOpen = false))
                              }))
                            : _createCommentVNode("v-if", true)
                        ]),
                        (_ctx.sharePanel.err)
                        ...
                        _createElementVNode("button", {
                          ...
                          onClick: _cache[28] || (_cache[28] = (...args) => (_ctx.addShare && _ctx.addShare(...args)))
                ...
                ? (_openBlock(), _createElementBlock("div", _hoisted_143, [
                    ...
                    _createElementVNode("div", null, [
                      _createElementVNode("button", {
                        type: "button",
                        class: "btn sm",
                        onClick: _cache[29] || (_cache[29] = (...args) => (_ctx.exportCollectionOds && _ctx.exportCollectionOds(...args)))
            ...
            _createElementVNode("div", _hoisted_145, [
              (_ctx.collForm.id)
                ? (_openBlock(), _createElementBlock("button", {
                    key: 0,
                    class: "btn danger",
                    onClick: _cache[30] || (_cache[30] = (...args) => (_ctx.removeCollection && _ctx.removeCollection(...args)))
              ...
              _createElementVNode("button", {
                class: "btn primary",
                onClick: _cache[32] || (_cache[32] = (...args) => (_ctx.saveCollection && _ctx.saveCollection(...args)))
    ...
    (_ctx.modal==='formula')
      ? (_openBlock(), _createElementBlock("div", {
          key: 1,
          class: "modal-mask",
          onClick: _cache[48] || (_cache[48] = _withModifiers($event => (_ctx.modal=null), ["self"]))
        }, [
          _createElementVNode("div", _hoisted_147, [
            _createElementVNode("div", _hoisted_148, [
              ...
              _createElementVNode("button", {
                class: "icon-btn",
                onClick: _cache[34] || (_cache[34] = $event => (_ctx.modal=null))
              }, "✕")
            ]),
            _createElementVNode("div", _hoisted_149, [
              _createElementVNode("div", _hoisted_150, [
                ...
                _withDirectives(_createElementVNode("input", {
                  class: "control",
                  "onUpdate:modelValue": _cache[35] || (_cache[35] = $event => ((_ctx.fForm.name) = $event)),
              ...
              _createElementVNode("div", _hoisted_152, [
                _createElementVNode("label", null, [
                  ...
                  _createElementVNode("span", _hoisted_153, [
                    _createElementVNode("button", {
                      ...
                      onClick: _cache[36] || (_cache[36] = $event => (_ctx.mdPreview=false))
                    }, _toDisplayString(_ctx.t('Write')), 3 /* TEXT, CLASS */),
                    _createElementVNode("button", {
                      type: "button",
                      class: _normalizeClass(["btn xs", {primary: _ctx.mdPreview}]),
                      onClick: _cache[37] || (_cache[37] = $event => (_ctx.mdPreview=true))
                ...
                (!_ctx.mdPreview)
                  ? _withDirectives((_openBlock(), _createElementBlock("textarea", {
                      key: 0,
                      class: "control",
                      "onUpdate:modelValue": _cache[38] || (_cache[38] = $event => ((_ctx.fForm.description) = $event)),
                      rows: "4",
              ...
              _createElementVNode("div", _hoisted_156, [
                ...
                _withDirectives(_createElementVNode("input", {
                  class: "control mono",
                  ref: "exprInput",
                  "onUpdate:modelValue": _cache[39] || (_cache[39] = $event => ((_ctx.fForm.expression) = $event)),
                  onInput: _cache[40] || (_cache[40] = (...args) => (_ctx.onExpr && _ctx.onExpr(...args))),
              ...
              _createElementVNode("div", _hoisted_166, [
                ...
                _createElementVNode("button", {
                  class: "btn xs",
                  onClick: _cache[42] || (_cache[42] = $event => (_ctx.fForm.variables.push({key:'',label:'',unit:'',default:''})))
            ...
            _createElementVNode("div", _hoisted_174, [
              ...
              _createElementVNode("button", {
                class: "btn",
                onClick: _cache[46] || (_cache[46] = $event => (_ctx.modal=null))
              }, _toDisplayString(_ctx.t('Cancel')), 1 /* TEXT */),
              _createElementVNode("button", {
                class: "btn primary",
                onClick: _cache[47] || (_cache[47] = (...args) => (_ctx.saveFormula && _ctx.saveFormula(...args)))
              }, _toDisplayString(_ctx.t('Save')), 1 /* TEXT */)
            ])
          ])
        ]))
      ...
      ? (_openBlock(), _createElementBlock("div", {
          ...
          _createElementVNode("div", _hoisted_176, [
            _createElementVNode("div", _hoisted_177, [
              ...
              _createElementVNode("button", {
                class: "icon-btn",
                onClick: _cache[49] || (_cache[49] = $event => (_ctx.modal=null))
              }, "✕")
            ]),
            _createElementVNode("div", _hoisted_178, [
              _createElementVNode("p", _hoisted_179, _toDisplayString(_ctx.t('Add a ready-made formula to the current collection.')), 1 /* TEXT */),
              _createElementVNode("div", _hoisted_180, [
                _hoisted_181,
                _withDirectives(_createElementVNode("input", {
                  class: "control",
                  type: "search",
                  "onUpdate:modelValue": _cache[50] || (_cache[50] = $event => ((_ctx.tplSearch) = $event)),
                ...
                (_ctx.tplSearch)
                  ? (_openBlock(), _createElementBlock("button", {
                      ...
                      onClick: _cache[51] || (_cache[51] = $event => (_ctx.tplSearch='')),
                      title: _ctx.t('Clear')
                    }, "✕", 8 /* PROPS */, _hoisted_183))
                  : _createCommentVNode("v-if", true),
                _createElementVNode("span", _hoisted_184, _toDisplayString(_ctx.templateMatchCount), 1 /* TEXT */)
              ]),
              (!_ctx.tplIndexLoaded)
                ? (_openBlock(), _createElementBlock("p", _hoisted_185, _toDisplayString(_ctx.t('Loading templates…')), 1 /* TEXT */))
                : (!_ctx.templatesByCat.length)
                  ? (_openBlock(), _createElementBlock("p", _hoisted_186, _toDisplayString(_ctx.t('No templates match your search.')), 1 /* TEXT */))
                  : _createCommentVNode("v-if", true),
                ...
                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.templatesByCat, (g) => {
                  return (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("button", {
                      ...
                      _hoisted_189,
                      _createElementVNode("span", _hoisted_190, _toDisplayString(_ctx.catIcon(g.cat)), 1 /* TEXT */),
                      _createElementVNode("span", _hoisted_191, _toDisplayString(_ctx.t(g.cat)), 1 /* TEXT */),
                      _createElementVNode("span", _hoisted_192, _toDisplayString(g.items.length), 1 /* TEXT */)
                    ], 8 /* PROPS */, _hoisted_188),
                    (_ctx.isGroupOpen(g.cat))
                      ? (_openBlock(), _createElementBlock("div", _hoisted_193, [
                          (!_ctx.tplCache[g.cat])
                            ? (_openBlock(), _createElementBlock("p", _hoisted_194, _toDisplayString(_ctx.t('Loading…')), 1 /* TEXT */))
                            : _createCommentVNode("v-if", true),
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.catItems(g), (tp) => {
                            return (_openBlock(), _createElementBlock("div", {
                              ...
                              _createElementVNode("div", _hoisted_195, [
                                ...
                                _createElementVNode("div", _hoisted_197, _toDisplayString(_ctx.t(tp.name)), 1 /* TEXT */),
                                (_ctx.isReversible(tp))
                                  ? (_openBlock(), _createElementBlock("span", {
                                      key: 0,
                                      class: "badge-outline",
                                      title: _ctx.t('This formula can be reverse-calculated (solve for a variable from the result).')
                                    }, "⇄ " + _toDisplayString(_ctx.t('Reversible')), 9 /* TEXT, PROPS */, _hoisted_198))
                                  : _createCommentVNode("v-if", true)
                              ]),
                              _createElementVNode("div", {
                                class: "tpl-expr",
      ...
      ? (_openBlock(), _createElementBlock("div", {
          ...
          _createElementVNode("div", _hoisted_203, [
            _createElementVNode("div", _hoisted_204, [
              ...
              _createElementVNode("button", {
                class: "icon-btn",
                onClick: _cache[54] || (_cache[54] = (...args) => (_ctx.cancelSettings && _ctx.cancelSettings(...args)))
              }, "✕")
            ]),
            _createElementVNode("div", _hoisted_205, [
                ...
                _createElementVNode("div", _hoisted_207, [
                  _createElementVNode("label", null, [
                    _withDirectives(_createElementVNode("input", {
                      type: "radio",
                      value: "auto",
                      "onUpdate:modelValue": _cache[55] || (_cache[55] = $event => ((_ctx.settingsForm.theme) = $event)),
                      onChange: _cache[56] || (_cache[56] = (...args) => (_ctx.previewTheme && _ctx.previewTheme(...args)))
                    }, null, 544 /* NEED_HYDRATION, NEED_PATCH */), [
                  ...
                  _createElementVNode("label", null, [
                    _withDirectives(_createElementVNode("input", {
                      type: "radio",
                      value: "light",
                      "onUpdate:modelValue": _cache[57] || (_cache[57] = $event => ((_ctx.settingsForm.theme) = $event)),
                      onChange: _cache[58] || (_cache[58] = (...args) => (_ctx.previewTheme && _ctx.previewTheme(...args)))
                    }, null, 544 /* NEED_HYDRATION, NEED_PATCH */), [
                      [_vModelRadio, _ctx.settingsForm.theme]
                    ]),
                  ...
                  _createElementVNode("label", null, [
                    _withDirectives(_createElementVNode("input", {
                      type: "radio",
                      value: "dark",
                      "onUpdate:modelValue": _cache[59] || (_cache[59] = $event => ((_ctx.settingsForm.theme) = $event)),
                      onChange: _cache[60] || (_cache[60] = (...args) => (_ctx.previewTheme && _ctx.previewTheme(...args)))
                    }, null, 544 /* NEED_HYDRATION, NEED_PATCH */), [
                      [_vModelRadio, _ctx.settingsForm.theme]
                    ]),
              ...
              _createElementVNode("div", _hoisted_208, [
                ...
                _withDirectives(_createElementVNode("select", {
                  "onUpdate:modelValue": _cache[61] || (_cache[61] = $event => ((_ctx.settingsForm.language) = $event))
                }, [
                  _createElementVNode("option", _hoisted_209, _toDisplayString(_ctx.t('System default (match Nextcloud)')), 1 /* TEXT */),
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.languages, (lg) => {
                    return (_openBlock(), _createElementBlock("option", {
                      key: lg.code,
                      value: lg.code
                    }, _toDisplayString(lg.name), 9 /* TEXT, PROPS */, _hoisted_210))
                  }), 128 /* KEYED_FRAGMENT */))
                ], 512 /* NEED_PATCH */), [
                  [_vModelSelect, _ctx.settingsForm.language]
                ]),
                _createElementVNode("div", _hoisted_211, _toDisplayString(_ctx.t('The display language switches when you press “Save”.')), 1 /* TEXT */)
              ]),
              _createElementVNode("div", _hoisted_212, [
                _createElementVNode("label", null, "💾 " + _toDisplayString(_ctx.t('Backup / Restore')), 1 /* TEXT */),
                _createElementVNode("div", _hoisted_213, _toDisplayString(_ctx.t('Save all your collections and formulas to a ZIP file, or restore them from one.')), 1 /* TEXT */),
                _createElementVNode("div", _hoisted_214, [
                  _createElementVNode("button", {
                    type: "button",
                    class: "btn sm",
                    onClick: _cache[62] || (_cache[62] = (...args) => (_ctx.openBackup && _ctx.openBackup(...args)))
                  }, "💾 " + _toDisplayString(_ctx.t('Download all data')), 1 /* TEXT */),
                  _createElementVNode("button", {
                    type: "button",
                    class: "btn sm",
                    onClick: _cache[63] || (_cache[63] = (...args) => (_ctx.openRestore && _ctx.openRestore(...args)))
            ...
            _createElementVNode("div", _hoisted_215, [
              ...
              _createElementVNode("button", {
                class: "btn",
                onClick: _cache[64] || (_cache[64] = (...args) => (_ctx.cancelSettings && _ctx.cancelSettings(...args)))
              }, _toDisplayString(_ctx.t('Cancel')), 1 /* TEXT */),
              _createElementVNode("button", {
                class: "btn primary",
                onClick: _cache[65] || (_cache[65] = (...args) => (_ctx.saveSettings && _ctx.saveSettings(...args)))
              }, _toDisplayString(_ctx.t('Save')), 1 /* TEXT */)
            ])
          ])
        ]))
    ...
    (_ctx.modal && _ctx.modal.type==='backup')
      ? (_openBlock(), _createElementBlock("div", {
          key: 4,
          class: "modal-mask",
          onClick: _cache[72] || (_cache[72] = _withModifiers($event => (!_ctx.backupForm.busy && (_ctx.modal=null)), ["self"]))
        }, [
          _createElementVNode("div", _hoisted_217, [
            ...
            _createElementVNode("form", {
              class: "modal-body",
              onSubmit: _cache[69] || (_cache[69] = _withModifiers((...args) => (_ctx.doBackup && _ctx.doBackup(...args)), ["prevent"]))
            }, [
              _createElementVNode("p", _hoisted_220, _toDisplayString(_ctx.t('Optionally set a password to encrypt the ZIP. Leave it blank for a plain (unencrypted) archive.')), 1 /* TEXT */),
              _createElementVNode("div", _hoisted_221, [
                _createElementVNode("label", null, _toDisplayString(_ctx.t('Password (optional)')), 1 /* TEXT */),
                _withDirectives(_createElementVNode("input", {
                  type: "password",
                  "onUpdate:modelValue": _cache[68] || (_cache[68] = $event => ((_ctx.backupForm.password) = $event)),
              ...
              (_ctx.backupForm.err)
                ? (_openBlock(), _createElementBlock("div", _hoisted_223, _toDisplayString(_ctx.backupForm.err), 1 /* TEXT */))
                : _createCommentVNode("v-if", true),
              (_ctx.backupForm.busy)
                ? (_openBlock(), _createElementBlock("div", _hoisted_224, _toDisplayString(_ctx.t('Creating…')), 1 /* TEXT */))
                : _createCommentVNode("v-if", true)
            ], 32 /* NEED_HYDRATION */),
            _createElementVNode("div", _hoisted_225, [
              ...
              }, _toDisplayString(_ctx.t('Cancel')), 9 /* TEXT, PROPS */, _hoisted_226),
              _createElementVNode("button", {
                class: "btn primary",
                disabled: _ctx.backupForm.busy,
                onClick: _cache[71] || (_cache[71] = (...args) => (_ctx.doBackup && _ctx.doBackup(...args)))
              }, _toDisplayString(_ctx.t('Download')), 9 /* TEXT, PROPS */, _hoisted_227)
            ])
          ])
        ]))
      : _createCommentVNode("v-if", true),
    (_ctx.modal && _ctx.modal.type==='restore')
      ? (_openBlock(), _createElementBlock("div", {
          key: 5,
          class: "modal-mask",
          onClick: _cache[82] || (_cache[82] = _withModifiers($event => (!_ctx.restoreForm.busy && (_ctx.modal=null)), ["self"]))
        }, [
          _createElementVNode("div", _hoisted_228, [
            ...
            _createElementVNode("div", _hoisted_231, [
              _createElementVNode("label", _hoisted_232, [
                _createElementVNode("input", {
                  type: "file",
                  accept: ".zip",
                  onChange: _cache[74] || (_cache[74] = (...args) => (_ctx.onRestoreFile && _ctx.onRestoreFile(...args)))
                }, null, 32 /* NEED_HYDRATION */),
                _createElementVNode("span", _hoisted_233, _toDisplayString(_ctx.t('📄 Choose file')), 1 /* TEXT */),
                _createElementVNode("span", _hoisted_234, _toDisplayString(_ctx.restoreForm.fileName || _ctx.t('Backup file (.zip)')), 1 /* TEXT */)
              ]),
              _createElementVNode("div", _hoisted_235, [
                ...
                _withDirectives(_createElementVNode("input", {
                  type: "password",
                  "onUpdate:modelValue": _cache[75] || (_cache[75] = $event => ((_ctx.restoreForm.password) = $event)),
                  autocomplete: "new-password"
                }, null, 512 /* NEED_PATCH */), [
                ...
                _createElementVNode("div", _hoisted_237, [
                  _createElementVNode("label", null, [
                    _withDirectives(_createElementVNode("input", {
                      type: "radio",
                      value: "overwrite",
                      "onUpdate:modelValue": _cache[76] || (_cache[76] = $event => ((_ctx.restoreForm.mode) = $event))
                    }, null, 512 /* NEED_PATCH */), [
                  ...
                  _createElementVNode("label", null, [
                    _withDirectives(_createElementVNode("input", {
                      type: "radio",
                      value: "merge",
                      "onUpdate:modelValue": _cache[77] || (_cache[77] = $event => ((_ctx.restoreForm.mode) = $event))
                    }, null, 512 /* NEED_PATCH */), [
                      [_vModelRadio, _ctx.restoreForm.mode]
                    ]),
              ...
              (_ctx.restoreForm.mode==='overwrite')
                ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                    _createElementVNode("p", _hoisted_238, _toDisplayString(_ctx.t('⚠️ Overwriting replaces ALL existing data (collections and formulas).')), 1 /* TEXT */),
                    _createElementVNode("label", _hoisted_239, [
                      _withDirectives(_createElementVNode("input", {
                        type: "checkbox",
                        "onUpdate:modelValue": _cache[79] || (_cache[79] = $event => ((_ctx.restoreForm.confirm) = $event))
                      }, null, 512 /* NEED_PATCH */), [
              ...
              (_ctx.restoreForm.err)
                ? (_openBlock(), _createElementBlock("div", _hoisted_240, _toDisplayString(_ctx.restoreForm.err), 1 /* TEXT */))
                : _createCommentVNode("v-if", true),
              (_ctx.restoreForm.busy)
                ? (_openBlock(), _createElementBlock("div", _hoisted_241, _toDisplayString(_ctx.t('Restoring…')), 1 /* TEXT */))
                : _createCommentVNode("v-if", true)
            ]),
            _createElementVNode("div", _hoisted_242, [
              ...
              }, _toDisplayString(_ctx.t('Cancel')), 9 /* TEXT, PROPS */, _hoisted_243),
              _createElementVNode("button", {
                ...
                onClick: _cache[81] || (_cache[81] = (...args) => (_ctx.doRestore && _ctx.doRestore(...args)))
              }, _toDisplayString(_ctx.t('Restore')), 11 /* TEXT, CLASS, PROPS */, _hoisted_244)
            ])
          ])
        ]))
      : _createCommentVNode("v-if", true),
    (_ctx.filePicker.open)
      ? (_openBlock(), _createElementBlock("div", {
          ...
          onClick: _cache[87] || (_cache[87] = _withModifiers($event => (_ctx.fpCancel()), ["self"]))
        }, [
          _createElementVNode("div", _hoisted_245, [
            _createElementVNode("div", _hoisted_246, [
              ...
              _createElementVNode("button", {
                class: "icon-btn",
                onClick: _cache[83] || (_cache[83] = $event => (_ctx.fpCancel()))
              }, "✕")
            ]),
            _createElementVNode("div", _hoisted_247, [
              _createElementVNode("div", _hoisted_248, [
                _createElementVNode("button", {
                  ...
                  onClick: _cache[84] || (_cache[84] = $event => (_ctx.fpUp()))
                }, _toDisplayString(_ctx.t('⬆ Up')), 9 /* TEXT, PROPS */, _hoisted_249),
                _createElementVNode("span", _hoisted_250, "/" + _toDisplayString(_ctx.filePicker.path), 1 /* TEXT */)
              ]),
              (_ctx.filePicker.loading)
                ...
                : (_ctx.filePicker.error)
                  ? (_openBlock(), _createElementBlock("p", _hoisted_252, _toDisplayString(_ctx.filePicker.error), 1 /* TEXT */))
                  : (!_ctx.filePicker.entries.length)
                    ? (_openBlock(), _createElementBlock("p", _hoisted_253, _toDisplayString(_ctx.t('No subfolders here.')), 1 /* TEXT */))
                    : (_openBlock(), _createElementBlock("div", _hoisted_254, [
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_ctx.filePicker.entries, (x) => {
                          return (_openBlock(), _createElementBlock("button", {
                            type: "button",
                            key: x.path,
                            class: "note-item fp-item",
                            onClick: $event => (_ctx.fpLoad(x.path))
                          }, [
                            _createElementVNode("span", _hoisted_256, "📁 " + _toDisplayString(x.name), 1 /* TEXT */),
                            _hoisted_257
            ...
            _createElementVNode("div", _hoisted_258, [
              _createElementVNode("button", {
                type: "button",
                class: "btn",
                onClick: _cache[85] || (_cache[85] = $event => (_ctx.fpCancel()))
              }, _toDisplayString(_ctx.t('Cancel')), 1 /* TEXT */),
              _createElementVNode("button", {
                type: "button",
                class: "btn primary",
                disabled: _ctx.filePicker.loading,
                onClick: _cache[86] || (_cache[86] = $event => (_ctx.fpConfirmFolder()))
              }, _toDisplayString(_ctx.t('Select this folder')), 9 /* TEXT, PROPS */, _hoisted_259)
            ])
          ])
        ]))
      : _createCommentVNode("v-if", true),
